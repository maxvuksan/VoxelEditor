...
- Tiles
    - Define tiles to make up the geometry of the level
- Material
    - Place materials and voxel meshes on said geometry
- Rope
    - Place ropes (defined as Bezier Curves) between points
- Generation
    - Paint generative effects to be applied to the defined voxel geometry
- Light
    - Paint light sprites to represent lit and unlit regions of the level
 - Render
